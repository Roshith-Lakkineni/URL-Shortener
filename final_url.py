...
db = SQLAlchemy(app) #binding of databse to object named app  which is created for flask module
Migrate(db,app)
...
##########  CREATE A MODEL  ##################
class url(db.Model): #blueprint to create an object 
    __tablename__= 'urls'
    ...
    def __repr__(self): #special method used to represent a class object as a string
